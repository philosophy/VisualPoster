<div id="right-col">
    <div id="save" class="box-cream">
        <div class="bg-top-box-cream"></div>
        <h3>SAVE $100</h3>
        <p>Save $100 when you <a href="#">buy flyers</a> to go with your posters.</p>
        <div class="bg-bottom-box-cream"></div>
    </div>
    <div id="which-size" class="box-cream">
        <div class="bg-top-box-cream"></div>
        <h3>Which Size To Buy</h3>
